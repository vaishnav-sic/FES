                ...
                <div className="row">
                        ...
                        <div className="course-details__content">
                            ...
                            <div className="course-details__top">
                                ...
                                <div className="course-details__top-right">
                                    <a href="#" className="course-one__category">marketing  
                                </div>
                            </div>
                            ...
                            <ul className="course-details__tab-navs list-unstyled nav nav-tabs" role="tablist">
                                <li>
                                    <a className="active" role="tab" data-toggle="tab" href="#overview">Overview  
                                </li>
                                <li>
                                    <a className="" role="tab" data-toggle="tab" href="#curriculum">Curriculum  
                                </li>
                                <li>
                                    <a className="" role="tab" data-toggle="tab" href="#review">Reviews  
                                </li>
                            </ul>
                                    ...
                                    <ul className="course-details__curriculum-list list-unstyled">
                                        <li>
                                            <div className="course-details__curriculum-list-left">
                                                ...
                                                <a href="#">Introduction to Editing   <span>Preview</span>
                                            </div>
                                        ...
                                        <li>
                                            <div className="course-details__curriculum-list-left">
                                                ...
                                                <a href="#">Overview of Editing   <span>Preview</span>
                                            </div>
                                        ...
                                        <li>
                                            <div className="course-details__curriculum-list-left">
                                                ...
                                                <a href="#">Basic Editing Technology  
                                            </div>
                                        </li>
                                        <li>
                                            <div className="course-details__curriculum-list-left">
                                    ...
                                    <ul className="course-details__curriculum-list list-unstyled">
                                        <li>
                                            <div className="course-details__curriculum-list-left">
                                                ...
                                                <a href="#">Introduction to Editing  
                                                <span>Preview</span>
                                            </div>
                                            <div
                                    ...
                                    <form action="#" className="course-details__comment-form">
                                        ...
                                        <p className="course-details__comment-form-text">Rate this Course? <a href="#"
                                            className="fas fa-star">  <a
                                                href="#" className="fas fa-star">  <a href="#"
                                                    className="fas fa-star">  <a
                                                        href="#" className="fas fa-star">  <a href="#"
                    ...
                    <div className="col-lg-4">
                        <div className="course-details__price">
                            ...
                            <a href="#" className="thm-btn course-details__price-btn">Buy This Course  
                        </div>
                        ...
                        <div className="course-details__list">
                            ...
                            <div className="course-details__list-item">
                                ...
                                <div className="course-details__list-content">
                                    <a className="course-details__list-author" href="#">by <span>Lydia Byrd</span>  
                                    <h3><a href="#">Marketing strategies  </h3>
