        ...
        <section className="course-category-three">
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-6 col-sm-12">
                        <div className="course-category-three__single">
                            ...
                            <div className="course-category-three__content">
                                <h3 className="course-category-three__title"><a href="#">IT & Software   </h3>
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-12">
                        <div className="course-category-three__single">
                            ...
                            <div className="course-category-three__content">
                                <h3 className="course-category-three__title"><a href="#">Development   </h3>
                                <p className="course-category-three__text">Over 752 Courses</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6 col-sm-12">
                        <div className="course-category-three__single">
                            ...
                            <div className="course-category-three__content">
                                <h3 className="course-category-three__title"><a href="#">Photography  </h3>
                                <p className="course-category-three__text">Over 752 Courses</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6 col-sm-12">
                        <div className="course-category-three__single">
                            ...
                            <div className="course-category-three__content">
                                <h3 className="course-category-three__title"><a href="#">Marketing  </h3>
                                <p className="course-category-three__text">Over 752 Courses</p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="text-center">
                    <a href="#" className="thm-btn course-category-three__more-link">View All Categories  
                </div>
            </div>
        </section>
    );
