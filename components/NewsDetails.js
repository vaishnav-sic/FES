                    ...
                    <div className="col-lg-8">
                            ...
                            <div className="blog-one__content text-center">
                                <div className="blog-one__meta">
                                    <a data-toggle="tooltip" data-placement="top" title="" href="#"
                                        data-original-title="Posted On Jan 19"><i className="fa fa-calendar-alt"></i>  
                                    <a data-toggle="tooltip" data-placement="top" title="" href="#"
                                        data-original-title="No Comments"><i className="fa fa-comments"></i>  
                                    <a data-toggle="tooltip" data-placement="top" title="" href="#"
                                        data-original-title="Posted By Admin"><i className="fa fa-user"></i>  
                                </div>
                        ...
                        <div className="share-block">
                            <div className="left-block">
                                <p>Tags: <a href="#">Business,   <a href="#">Agency,   <a href="#">Technology  
                                </p>
                            </div>
                            <div className="social-block">
                                ...
                                <a href="#"><i className="fab fa-dribbble"></i>  
                            </div>
                        </div>
                                ...
                                <div className="comment-one__content">
                                    <div className="comment-one__content-top">
                                        ...
                                        <div className="comment-one__top-right">
                                            <a href="#" className="thm-btn comment-one__reply">Reply  
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="sidebar">
                            ...
                            <div className="sidebar__single sidebar__category">
                                ...
                                <ul className="sidebar__category-list">
                                    <li className="sidebar__category-list-item"><a href="#">Business  </li>
                                    <li className="sidebar__category-list-item"><a href="#">Introductions  </li>
                                    <li className="sidebar__category-list-item"><a href="#">One Page Template  </li>
                                    <li className="sidebar__category-list-item"><a href="#">Parallax Effects  </li>
                                    <li className="sidebar__category-list-item"><a href="#">New Technologies  </li>
                                    <li className="sidebar__category-list-item"><a href="#">Video Backgrounds  </li>
                                </ul>
                            </div>
                            <div className="sidebar__single sidebar__tags">
                                <h3 className="sidebar__title">Tags</h3>
                                <ul className="sidebar__tags-list">
                                    <li className="sidebar__tags-list-item"><a href="#">Business,  </li>
                                    <li className="sidebar__tags-list-item"><a href="#">Agency,  </li>
                                    <li className="sidebar__tags-list-item"><a href="#">Technology,  </li>
                                    <li className="sidebar__tags-list-item"><a href="#">Parallax,  </li>
                                    <li className="sidebar__tags-list-item"><a href="#">Innovative,  </li>
                                    <li className="sidebar__tags-list-item"><a href="#">Professional,  </li>
                                    <li className="sidebar__tags-list-item"><a href="#">Experience,  </li>
                                </ul>
                            </div>
                        </div>
                    </div>
